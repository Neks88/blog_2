...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('app/css/crumina-fonts.cs') }}">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{route('category.single', ["post"=>$first_post->category->id])}}">{{$first_post->category->name}}</a>
                                        </span>
